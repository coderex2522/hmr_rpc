...
enum hmr_log_level global_log_level=HMR_LOG_LEVEL_TRACE;

const char *const level_str[]={
	"ERROR", "WARN", "INFO", "DEBUG","TRACE"
};
	
void hmr_log_impl(const char * file, unsigned line, const char * func, unsigned log_level, const char * fmt, ...)
{
	va_list args;
	char mbuf[2048];
	int mlength=0;
